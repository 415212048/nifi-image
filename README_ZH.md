...
## 项目介绍
‌[NiFi‌](https://github.com/apache/nifi) 是一个易于使用、功能强大而且可靠的流式数据处理和分发系统。
...
| 镜像规格                                                                                                                                 | 特性说明                                           | 备注 |
|--------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------| --- |
| [Nifi1.28.1-arm-v1.0](https://marketplace.huaweicloud.com/hidden/contents/e2912d41-ea32-480f-b210-3b98197c76a4#productid=OFFI1128523591003291648) | 基于 鲲鹏服务器 + Huawei Cloud EulerOS 2.0 64bit 安装部署 |  |
